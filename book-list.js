...
const deleteBook = (isbn) => {
  ...
  xhttp.open("DELETE", `http://localhost:3000/books/${isbn}`, true);
  xhttp.send();
...
window.addEventListener('load', (event) => {
  ...
  // const booksLoaded = document.querySelectorAll(".card-body");

  // booksLoaded.forEach((book) => {

  //   const isbn = book.querySelector("h6").innerText
  //   const btn = book.querySelector(".btn-danger")
